 ...
 * @return PropertyDecorator
 */
export declare function Model(event?: string, options?: PropOptions | Constructor[] | Constructor): (target: Vue<unknown>, key: string) => void;
/**
 * decorator of a prop
 * @param  options the options for the prop
 * @return PropertyDecorator | void
 */
export declare function Prop(options?: PropOptions | Constructor[] | Constructor): (target: Vue<unknown>, key: string) => void;
/**
 ...
 * @return MethodDecorator
 */
export declare function Emit(event?: string): (_target: Vue<unknown>, propertyKey: string, descriptor: any) => void;
/**
